...
(function (G) {
  function r(d, b, c) {
    var h = 0, a = [], g = 0, f, m, k, e, l, p, q, t, w = !1, n = [], u = [], v, r = !1;
    c = c || {};
    f = c.encoding || "UTF8";
    v = c.numRounds || 1;
    ...
    this.reset = function () {
      h = 0, a = [], g = 0, w = !1, n = [], u = [], r = !1;
      c = c || {};
      f = c.encoding || "UTF8";
      v = c.numRounds || 1;
      if (v !== parseInt(v, 10) || 1 > v) throwError("numRounds must a integer >= 1");
      if ("SHA-1" === d) l = 512, p = z, q = H, e = 160, t = function (a) {
        return a.slice()
      }; else throw Error("Chosen SHA variant is not supported");
      k = A(b, f);
    ...
    this.update = function (b) {
      ...
      a = f.slice(d >>> 5);
      g = b % l;
      r = !0, e = undefined, f = undefined, c = undefined, d = undefined, q = undefined;
    };
  ...
  function D(d, b, c) {
    var h = "", a = b / 8, g, f, m;
    for (g = 0; g < a; g += 3) for (f = g + 1 < a ? d[g + 1 >>> 2] : 0, m = g + 2 < a ? d[g + 2 >>> 2] : 0, m = (d[g >>> 2] >>> 8 * (3 + g % 4 * -1) & 255) << 16 | (f >>> 8 * (3 + (g + 1) % 4 * -1) & 255) << 8 | m >>> 8 * (3 + (g + 2) % 4 * -1) & 255, f = 0; 4 > f; f += 1) 8 * g + 6 * f <= b ? h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(m >>>
      6 * (3 - f) & 63) : h += c.b64Pad;
    return h
  }
  ...
  function F(d, b) {
    var c = b / 8, h, a = new ArrayBuffer(c);
    ...
    switch (d) {
      case "HEX":
        c = function (b, a, g) {
          ...
          return { value: a, binLen: 4 * f + g }
        };
        break;
      case "TEXT":
        c = function (c, a, g) {
          var f, d, k = 0, e, l, p, q, t, n;
          a = a || [0];
          g = g || 0;
          p = g >>> 3;
          if ("UTF8" === b) for (n = 3, e = 0; e < c.length; e += 1) for (f = c.charCodeAt(e), d = [], 128 > f ? d.push(f) : 2048 > f ? (d.push(192 | f >>> 6), d.push(128 | f & 63)) : 55296 > f || 57344 <= f ? d.push(224 | f >>> 12, 128 | f >>> 6 & 63, 128 | f & 63) : (e += 1, f = 65536 + ((f & 1023) << 10 | c.charCodeAt(e) & 1023), d.push(240 | f >>> 18, 128 | f >>> 12 & 63, 128 | f >>> 6 & 63, 128 | f & 63)), l = 0; l < d.length; l += 1) {
            t = k +
              p;
          ...
          return { value: a, binLen: 8 * k + g }
        };
        break;
      case "B64":
        c = function (b, a, c) {
          var f = 0, d, k, e, l, p, q, n;
